...
KEYWORDS_PATH = Path('/Users/sanghoonjung/PycharmProjects/PythonProject/youtube_rolling3/beauty/files/beauty_keywords_sample.csv')
...
# NOTE: Matching is performed on RAW title/description/tags (NFKC + lowercase, punctuation preserved),
# so contiguous patterns (e.g., \bLANEIGE\b) will NOT match punctuated or spaced variants like "La,neige" or "La neige".
...
def discover_for_day(T: date, kw_map: Dict[str, List[str]]) -> pd.DataFrame:
    ...
    for day in dates_to_search:
        ...
        for main_kw, patt in alias_patts.items():
